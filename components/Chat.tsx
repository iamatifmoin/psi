...
type Clip = { start_time: number; end_time: number; result_start_time: number; label?: string; reason?: string; energy_score?: number };
...
function Studio() {
  ...
  function choose(next: File | undefined) {
    if (!next) return;
    if (next.type !== "video/mp4" && !next.name.toLowerCase().endsWith(".mp4")) { toast({ title: "MP4 required", message: "Choose a short MP4 video.", variant: "info" }); return; }
